...
def main():
    ...
    st.sidebar.markdown("Are your mushrooms edible or poisonous? 🍄")  # markdown is used to insert strings as text

    # we use this st decorator since we don't want the app to load the data everytime that we make changes to the code
    ...
    if classifier == "Random Forest":
        st.sidebar.subheader("Model Hyperparameters")
        n_estimators = st.sidebar.number_input("The number of trees in the forest", 100, 5000, step=10, key="n")
    ...
    if st.sidebar.checkbox("Show raw data", False):
        ...
        st.markdown("This data set includes descriptions of hypothetical samples corresponding to 23 species "
                    "of gilled mushrooms in the Agaricus and Lepiota Family (pp. 500-525).  Each species is identified "
